  ...
  return (
    <section className="flex max-lg:flex-col">
      <div className="w-[50%] min-h-screen flex justify-center flex-col max-lg:w-full">
        <h1 className="text-6xl leading-[70px] font-bold flex max-sm:text-5xl font-palanquin">
          Hi There, <br /> I'm{" "}
        </h1>
        <h1 className="text-6xl leading-[70px] font-bold flex max-sm:text-5xl font-palanquin">
          Vivek
          <span className="text-blue-300 flex ml-3">
            <p id="name">C</p>
            <p id="name">h</p>
            <p id="name">a</p>
            <p id="name">u</p>
        ...
        <p className="text-2xl mt-7 font-montserrat">
          I am a{" "}
          <span id="text" className="text-blue-300 font-bold">
            {text}
          </span>
        </p>
        <div className="mt-10">
